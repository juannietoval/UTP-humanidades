  ...
  return (
    <section className="section" id="programa" style={{ minHeight: '80vh' }}>
      <div className="container">
        ...
        <h2 style={{ marginBottom: 'calc(var(--base-unit) * 6)', borderBottom: '2px solid var(--primary)', paddingBottom: '16px', marginTop: 'calc(var(--base-unit) * 8)' }}>Proceso de Formación</h2>
        ...
        <div className="grid" style={{ marginBottom: 'calc(var(--base-unit) * 8)' }}>
          ...
          <div style={{ gridColumn: 'span 8' }}>
            <ul className="archival-list">
              {syllabusData.proceso.metodologia.map((met, i) => (
                <li key={i}>
        ...
        <div className="grid" style={{ marginBottom: 'calc(var(--base-unit) * 8)' }}>
          ...
          <div style={{ gridColumn: 'span 8' }}>
            <div className="grid">
              {syllabusData.proceso.evaluacion.map((ev, i) => (
